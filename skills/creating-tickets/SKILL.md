...
when_to_use: when creating sub-tickets during breakdown planning, or creating any ticket that will be executed through DLC workflows
---
...
Follow test-driven-development skill (dlc:test-driven-development):
...
**Use PM MCP tools (Linear, JIRA, or other):**

```python
# Example with Linear
ticket = mcp__linear-server__create_issue({
