...
**Related:** For comprehensive guidance on writing effective tests, see `Skill(writing-tests)` which covers:
...
- **Skill(writing-tests)** - Comprehensive guide to writing effective tests (AAA structure, test levels, mocking, coverage)
